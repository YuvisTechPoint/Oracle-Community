...
import Card from "../ComponentModel/Card";
import { Globe } from "@/components/ui/globe";

import CopyEmailButton from "../ComponentModel/CopyEmailButton";
import { Frameworks } from "../ComponentModel/FrameWorks";
import Logo from "../assets/coding-pov.png";
    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-8">
        ...
        <div className="grid-default-color grid-2">
          ...
          >
            <p className="flex items-end text-5xl text-gray-500 font-extrabold">
              CODE IS CRAFT
            </p>
            <Card
